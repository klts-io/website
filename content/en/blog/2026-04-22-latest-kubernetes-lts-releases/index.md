---
layout: blog
title: "Latest KLTS Kubernetes LTS Releases (April 22, 2026)"
date: 2026-04-22
---

We have synced the latest Kubernetes LTS release information to the KLTS website. This update reflects the KLTS releases published on April 22, 2026.
...
## April 22 release highlights

- v1.21 through v1.32 were refreshed with Go 1.25.9 builds.
- The newer release lines carry current KLTS image, registry, code generation, and etcd maintenance patch chains as applicable.
- Current security backports remain documented in the Kubernetes patch section and are referenced from the updated release pages.
